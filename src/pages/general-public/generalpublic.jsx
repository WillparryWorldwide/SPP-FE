						...
						<section className="content user-main">
							<div className="container-fluid h-100">
								<div className="row h-100">
									{/* Main section  */}
									<div
										className={`${viewComment || viewListComment
											? " col-lg-9 "
											: " col-lg-12 "
																	...
																	>
																		{item.images.length > 0 && (
																			...
																			<div className="w-100 card-image">
																				...
																				/>
																				<div className="stage">
																					<span className={`mb-0 text-${item.open ? "primary" : "danger"}`}>{item.open ? "Ongoing" : "Closed"}</span>
																				</div>
																			</div>
																		)}
																		<div className="card-body text-dark pl-2 pr-2">
																			...
																			<div className="flex w-100">
																				<div className="fill-available p-0 ">
																					<p className="mb-1 text-xs line-clamp">Project Cost</p>
