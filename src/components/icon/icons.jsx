...
const Icon = (props) => {
    return (
        ...
        {props.around_you && <svg className="fill-inherit" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#a)" stroke="inherit" stroke-width="1.333">
                                <path d="M8 1.334v5.667" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M7.999 1.334a6.667 6.667 0 1 0 5.264 2.576" stroke-linecap="round"></path>
                                <path d="M7.999 4.334a3.667 3.667 0 1 0 2.895 1.417" stroke-linecap="round"></path>
                                <path d="M8 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"></path>
                            </g>
                            <defs>
                                <clipPath id="a">
                                    <path  fill="inherent" d="M0 0h16v16H0z"></path>
                                </clipPath>
                            </defs>
                        </svg>
        }
        {props.special_projects && <svg className="fill-inherit" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9 13h4v1H9v-1Zm0-2h6v1H9v-1Zm0-2h6v1H9V9Z" fill="inherent"></path>
                            <path d="M10.275 5.609 8.001 1 5.726 5.609l-5.085.739 3.68 3.587L3.45 15l3.55-1.866v-1.13l-2.22 1.168.525-3.068.09-.518-.377-.367-2.23-2.173 3.081-.448.52-.075.233-.472 1.378-2.792 1.377 2.792.233.471.52.076 3.727.543.143-.991-3.726-.542Z" fill="inherent"></path>
                        </svg>
        }
        {props.major_roads && <svg className="fill-inherit" width="18" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#a)">
                                <path d="m17.912 12.583-4.368-10A.951.951 0 0 0 12.678 2h-3.05l.077.724a.25.25 0 0 1-.25.276h-.91a.25.25 0 0 1-.25-.276L8.373 2h-3.05a.951.951 0 0 0-.866.583l-4.368 10C-.202 13.246.26 14 .955 14h6.15l.323-3.053a.5.5 0 0 1 .497-.447h2.15a.5.5 0 0 1 .497.447L10.895 14h6.15c.695 0 1.157-.754.867-1.417Zm-9.774-8.36A.25.25 0 0 1 8.386 4h1.228a.25.25 0 0 1 .249.224l.144 1.362A.375.375 0 0 1 9.634 6H8.367a.375.375 0 0 1-.373-.414l.144-1.362ZM9.864 9.5H8.136a.5.5 0 0 1-.497-.553l.158-1.5A.5.5 0 0 1 8.295 7h1.41a.5.5 0 0 1 .498.447l.158 1.5a.5.5 0 0 1-.497.553Z" fill="inherent"></path>
                            </g>
                            <defs>
                                <clipPath id="a">
                                    <path  fill="inherent" d="M0 0h18v16H0z"></path>
                                </clipPath>
                            </defs>
                        </svg>
        ...
        {props.list_menu && <svg className="fill-inherit" width="38" height="38" fill="none" xmlns="http://www.w3.org/2000/svg" data-testid="set-view_map">
                        <rect x="0.5" y="0.5" width="37" height="37" rx="6.5" fill="currentColor" stroke="#fff"></rect>
                        ...
                        <path d="M16 12v16M22 10v16" stroke="#DCDCDC" stroke-width="1.5" stroke-linejoin="round"></path>
                    </svg>
        }
        ...
        {props.drop_down && <svg className="fill-inherit" width="8" height="6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 5.26a.52.52 0 0 1-.37-.153L.15 1.627A.522.522 0 0 1 .888.888L4 4 7.112.888a.522.522 0 0 1 .738.739l-3.48 3.48A.52.52 0 0 1 4 5.26Z" fill="#A0AFBF"></path>
                    </svg>
        }
    </>
